			...
			<div class="container-fluid">
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> <?php echo $this->session->userdata('email');?>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#"><i class="halflings-icon user"></i> </i><?php echo $this->session->userdata('username');?></a></li>
