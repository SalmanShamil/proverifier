<div id="content" class="span10">
				...
				<div class="row-fluid sortable">
						...
						<div><img src="<?php echo base_url('assets/dashboard/img/rokon.jpg');?>" style="border-radius: 50%; display: block; margin-left: auto; margin-right: auto; width: 150px; height: 150px"></div>
					...
					<div class="box-content">
						<table class="table table-bordered table-striped table-condensed">  
							  <tbody>
								...
								<tr>
									<td>User Type:</td>
									<td class="center"><strong>General User</strong></td>                                    
								</tr>
								<tr>
									<td>Email:</td>
